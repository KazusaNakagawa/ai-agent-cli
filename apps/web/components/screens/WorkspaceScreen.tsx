...
import { isImageFile, isLogFile, languageForFile } from "@/lib/fileColors"
import {
  readFileHandle,
...
export function WorkspaceScreen() {
  ...
  // Load the selected file whenever the sidebar selection changes. Images
  // load as an object URL for <img>; everything else loads as text.
  useEffect(() => {
    ...
    const load = isImageFile(selected.path)
