...
> **Not investment advice.** Briefings are generated by an LLM from web search results and can be wrong, incomplete or out of date. Nothing this software produces is a recommendation to buy or sell any security. Verify information independently and make your own decisions at your own risk. The software is provided as is, without warranty under the MIT License.
